...
public class TeacherExamController {
    ...
    public Map<String, Object> editExam(@RequestBody Map<String, Object> requestBody) {
        ExamDTO examDTO = new ExamDTO();
        examDTO.setName((String) requestBody.get("name"));
        ...
        examDTO.setId((Integer) requestBody.get("id"));
        examService.editExam(examDTO);
        return Map.of("result", "考试修改成功");
    }

    @PostMapping("/deleteExam")
    public Map<String, Object> deleteExam(@RequestBody Map<String, Integer> requestBody) {
        examService.deleteExam(requestBody.get("id"));
        return Map.of("result", "考试删除成功");
    }
